...
- **Software of Unknown Provenance (SOUP) not tracked.** For software medical devices, every third-party library is a SOUP item. Keep those in a controlled SOUP register with version, anomaly evaluation, and direct requirement/test linkage rather than leaving them implicit.
